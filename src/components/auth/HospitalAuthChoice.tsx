...
interface HospitalAuthChoiceProps {
  onBack: () => void;
  onSignIn: () => void;
  onRegister: () => void;
}

const HospitalAuthChoice = ({ onBack, onSignIn, onRegister }: HospitalAuthChoiceProps) => {
  return (
    <div className="min-h-screen gradient-hero flex flex-col px-6 py-8">
      ...
      >
        ...
        <h2 className="text-xl font-bold text-foreground">Hospital</h2>
      </motion.div>
      ...
      >
        ...
        <p className="text-muted-foreground text-center mb-10">
          Sign in to manage your hospital or register a new one
        </p>
...
export default HospitalAuthChoice;
